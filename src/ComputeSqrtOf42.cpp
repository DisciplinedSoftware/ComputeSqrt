...
// Forward declaration
class large_integer;
constexpr std::optional<large_integer> from_string(const std::string& str_);
...
private:
    ...
    [[nodiscard]] static constexpr std::strong_ordering compare_large_unsigned_integer(const collection_type& lhs_,
...
[[nodiscard]] constexpr std::string multiply_integer_as_string_by_integer(const std::string& num_,
...
TEST_CASE("large_integer") {
    ...
    CHECK(large_integer::from_string("6779575297923493247898029418281817537676227380624747815049013732411535947860165631075856579568246233910811591607874120563664388642279371457390259857568960958935772908009048011104104746617436179252684469483776429833549880669503680760948677500"s).value()
        - large_integer::from_string("6480740698407860230965967436087996657705204307058346549711354397809617377844044371400360906605610235675450542097411694335491913404906608688945818961664673951305585227822636095668822680668761521776633672599142812990432160139844957280499363525"s).value()
